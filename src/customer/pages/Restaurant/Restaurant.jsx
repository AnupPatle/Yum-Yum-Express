...
import { Divider, Typography, FormControl, RadioGroup, FormControlLabel } from '@mui/material'
    ...
    <div className='px-5 lg:px-20'>
        <section>
          <h3 className='text-gray-500 py-2 mt-10'>
            {`Home/india/Yum-Yum Restaurant/2/Order Online`}
          </h3>
          ...
          <div>
            <h1 className='text-4xl py-1 font-semibold'>{`Yum-Yum Restaurant`}</h1>
            <p className='text-gray-500'>
            Crispy Chicken Parmesan: Golden-fried chicken cutlets, smothered in rich marinara sauce, 
            topped with melted mozzarella cheese, and garnished with fresh basil.
            </p>
