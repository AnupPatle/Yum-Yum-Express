...
import { Card, Button,Modal,Box } from '@mui/material'
        ...
        <main className='lg:flex justify-between'>
           ...
           <AddLocationAltIcon/>
            <div className='space-y-3 text-gray-500'>
                <p>Add New Address</p>
                <Button onClick={handleOpenddressModal} fullWidth variant="contained" sx={{padding:"0.75rem"}}>
                    Add
                    </Button>
                </div>
            </Card>
